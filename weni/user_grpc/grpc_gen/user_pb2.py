...
_UPDATEUSERLANG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='email', full_name='user.UpdateUserLang.email', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='language', full_name='user.UpdateUserLang.language', index=1,
...
UpdateUserLang = _reflection.GeneratedProtocolMessageType('UpdateUserLang', (_message.Message,), {
  ...
  '__module__' : 'weni.user_grpc.grpc_gen.user_pb2'
  # @@protoc_insertion_point(class_scope:user.UpdateUserLang)
  })
