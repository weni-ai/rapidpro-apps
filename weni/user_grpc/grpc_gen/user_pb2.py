...
_USERPERMISSIONRETRIEVEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='weni.rapidpro.user.UserPermissionRetrieveRequest.user_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='org_id', full_name='weni.rapidpro.user.UserPermissionRetrieveRequest.org_id', index=1,
...
_USERPERMISSIONUPDATEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='org_id', full_name='weni.rapidpro.user.UserPermissionUpdateRequest.org_id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='user_id', full_name='weni.rapidpro.user.UserPermissionUpdateRequest.user_id', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
