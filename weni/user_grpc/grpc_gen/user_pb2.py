...
_USERPERMISSIONRETRIEVEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="user_id",
            full_name="weni.rapidpro.user.UserPermissionRetrieveRequest.user_id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="org_uuid",
            full_name="weni.rapidpro.user.UserPermissionRetrieveRequest.org_uuid",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_USERPERMISSIONUPDATEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="org_uuid",
            full_name="weni.rapidpro.user.UserPermissionUpdateRequest.org_uuid",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="user_id",
            full_name="weni.rapidpro.user.UserPermissionUpdateRequest.user_id",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="permission",
            full_name="weni.rapidpro.user.UserPermissionUpdateRequest.permission",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_PERMISSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="administrator",
            full_name="weni.rapidpro.user.Permission.administrator",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="viewer",
            full_name="weni.rapidpro.user.Permission.viewer",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="editor",
            full_name="weni.rapidpro.user.Permission.editor",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="surveyor",
            full_name="weni.rapidpro.user.Permission.surveyor",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
...
_USERRETRIEVEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="email",
            full_name="weni.rapidpro.user.UserRetrieveRequest.email",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_UPDATEUSERLANG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="email",
            full_name="weni.rapidpro.user.UpdateUserLang.email",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="language",
            full_name="weni.rapidpro.user.UpdateUserLang.language",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_USER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="weni.rapidpro.user.User.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="email",
            full_name="weni.rapidpro.user.User.email",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="username",
            full_name="weni.rapidpro.user.User.username",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="first_name",
            full_name="weni.rapidpro.user.User.first_name",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="last_name",
            full_name="weni.rapidpro.user.User.last_name",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="date_joined",
            full_name="weni.rapidpro.user.User.date_joined",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="is_active",
            full_name="weni.rapidpro.user.User.is_active",
            index=6,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="is_superuser",
            full_name="weni.rapidpro.user.User.is_superuser",
            index=7,
            number=8,
            type=8,
            cpp_type=7,
...
UpdateUserLang = _reflection.GeneratedProtocolMessageType(
    "UpdateUserLang",
    (_message.Message,),
    {
