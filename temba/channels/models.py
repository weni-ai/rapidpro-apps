...
class Channel(TembaModel):
    ...
    CONFIG_MESSANGI_PUBLIC_KEY = 'messangi_public_key'
    CONFIG_MESSANGI_PRIVATE_KEY = 'messangi_private_key'
    CONFIG_MESSANGI_CARRIER_ID = 'messangi_carrier_id'
    CONFIG_MESSANGI_INSTANCE_ID = 'messangi_instance_id'
